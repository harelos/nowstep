// Nowstep — Play Billing (Digital Goods API) + paywall. Generated. Loaded after the app.
(function(){'use strict';
const CFG={"key":"ns_ent","event":"nowstep-pro-changed","app":"Nowstep","accent":"#E85D3D","bg":"#FFFFFF","p1":"#FBF7F0","line":"#EAE2D4","ink":"#211D16","mut":"#8A8172","title":"Go hands-free","sub":"Voice-guided routines so you never have to look at your phone mid-step.","benefits":["<b>Voice / spoken step cues</b> — Nowstep reads each step aloud so you keep moving","Alarm-grade step timers with vibration","Unlimited routines + shareable packs"],"plans":[{"key":"pro_lifetime","name":"Lifetime","price":"$24.99","per":" once","tag":"Pay once, keep forever","hero":true},{"key":"pro_yearly","name":"Annual","price":"$19.99","per":"/yr","tag":"Cancel anytime"},{"key":"packstudio","name":"Pack Studio","price":"$4.99","per":" add-on","tag":"Create & share routine packs"}],"grants":{"pro_lifetime":"pro","pro_yearly":"pro","packstudio":"pro"}};
